...
from taxvault.db.models import FilingRecord, TaxDocument, Taxpayer
    ...
    *,
    ...
    for year in years:
        ...
        for jurisdiction, code in jurisdictions:
            ...
            # Three calendar years, not 1,095 days: counting in days lands a day
            # early whenever a leap year falls inside the window, and this date
            # is the one a client plans around.
            refund_deadline = date(due.year + 3, due.month, due.day)
